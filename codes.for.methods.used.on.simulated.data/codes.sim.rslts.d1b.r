...
sim.normal.dat  <- read.table(".../sim.data.d1b.normal.csv", header = TRUE, sep = ",")
sim.cauchy.dat  <- read.table(".../sim.data.d1b.cauchy.csv", header = TRUE, sep = ",")
...
T <- 300 # Number of random samples
#set.seed(123)

d1b.normal.dat  <- read.table(".../normal.d1b.corr.csv", header = FALSE, sep = ",")
d1b.cauchy.dat  <- read.table(".../cauchy.d1b.corr.csv", header = FALSE, sep = ",")


dnm <- dcc.normal.mat <- d1b.normal.dat[,(2*c(0:999)) + 1]
dcm <- dcc.cauchy.mat <- d1b.cauchy.dat[,(2*c(0:999)) + 1]
