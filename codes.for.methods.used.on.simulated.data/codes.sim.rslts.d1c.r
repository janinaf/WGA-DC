...
sim.normal.dat  <- read.table(".../sim.data.d1c.normal.csv", header = TRUE, sep = ",")
sim.cauchy.dat  <- read.table(".../sim.data.d1c.cauchy.csv", header = TRUE, sep = ",")
...
d1c.normal.dat  <- read.table(".../normal.d1c.corr.csv", header = FALSE, sep = ",")
d1c.cauchy.dat  <- read.table(".../cauchy.d1c.corr.csv", header = FALSE, sep = ",")


dnm <- dcc.normal.mat <- d1c.normal.dat[,(2*c(0:999)) + 1]
dcm <- dcc.cauchy.mat <- d1c.cauchy.dat[,(2*c(0:999)) + 1]
