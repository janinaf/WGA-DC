...
#sim.normal.dat  <- read.table(".../sim.data.d1d.normal.csv", header = TRUE, sep = ",")
sim.cauchy.dat  <- read.table(".../sim.data.d1d.cauchy.csv", header = TRUE, sep = ",")
...
#d1d.normal.dat  <- read.table(".../normal.d1d.corr.csv", header = FALSE, sep = ",")
d1d.cauchy.dat  <- read.table(".../cauchy.d1d.corr.csv", header = FALSE, sep = ",")


#dnm <- dcc.normal.mat <- d1d.normal.dat[,(2*c(0:999)) + 1]
dcm <- dcc.cauchy.mat <- d1d.cauchy.dat[,(2*c(0:999)) + 1]
