...
sim.normal.dat  <- read.table(".../sim.data.d2b.normal.csv", header = TRUE, sep = ",")
sim.cauchy.dat  <- read.table(".../sim.data.d2b.cauchy.csv", header = TRUE, sep = ",")
...
d2b.normal.dat  <- read.table(".../normal.d2b.corr.csv", header = FALSE, sep = ",")
d2b.cauchy.dat  <- read.table(".../cauchy.d2b.corr.csv", header = FALSE, sep = ",")


dnm <- dcc.normal.mat <- d2b.normal.dat[,(2*c(0:999)) + 1]
dcm <- dcc.cauchy.mat <- d2b.cauchy.dat[,(2*c(0:999)) + 1]
