...
sim.normal.dat  <- read.table(".../sim.data.d1a.normal.csv", header = TRUE, sep = ",")
sim.cauchy.dat  <- read.table(".../sim.data.d1a.cauchy.csv", header = TRUE, sep = ",")
...
T <- 150 # Number of random samples
#set.seed(123)

d1a.normal.dat  <- read.table(".../normal.d1a.corr.csv", header = FALSE, sep = ",")
d1a.cauchy.dat  <- read.table(".../cauchy.d1a.corr.csv", header = FALSE, sep = ",")


dnm <- dcc.normal.mat <- d1a.normal.dat[,(2*c(0:999)) + 1]
dcm <- dcc.cauchy.mat <- d1a.cauchy.dat[,(2*c(0:999)) + 1]
